...
class WorkLogsControllerTest < ActionController::TestCase
  ...
  test "should create work_log" do
    assert_difference('WorkLog.count') do
      post :create, work_log: { end_time: @work_log.end_time, start_time: @work_log.start_time, type: @work_log.type }
    end
  ...
  test "should update work_log" do
    patch :update, id: @work_log, work_log: { end_time: @work_log.end_time, start_time: @work_log.start_time, type: @work_log.type }
    assert_redirected_to work_log_path(assigns(:work_log))
  end
